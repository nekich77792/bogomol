...
var GameObj = /*#__PURE__*/_createClass(function GameObj(x, y) {
...
;
var Platform = exports.Platform = /*#__PURE__*/function (_GameObj) {
...
var GO = exports.GO = 1;
var JUMP = exports.JUMP = 2;
var DEATH = exports.DEATH = 3;
...
;
var Input = exports.Input = /*#__PURE__*/_createClass(function Input() {
...
exports.Sprite = exports.Anim = void 0;
var _classes = require("./../classes");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
    ...
    value: function draw(ctx, state, pos, dir, attack) {
      ...
      if (dir == _classes.L) {
        ...
        var _xx = -shift,
          ...
          _ww = w,
          _hh = h;
        ctx.drawImage(this.img, srcX, y0, w, h, _xx,
        //-shift,//pos.x - shift, 
        _yy, _ww, _hh);
...
var Anim = exports.Anim = /*#__PURE__*/_createClass(function Anim(n, x0, y0, w, h, spriteTime, shift) {
...
function createHeroSprite() {
  ...
  heroImage.src = _ForestBoy.default;
...
function createEnemy1Sprite(enemy) {
  ...
  anims.set(_classes.DEATH, new _sprite.Anim(4, 0, 0, 30, 15, 8));
...
function loop() {
  ...
  (0, _physics.applyPhysics)(state, input);
...
*/
},{"./inputs":"inputs.js","./physics":"physics.js","./platforms":"platforms.js","./classes":"classes.js","./time":"time.js","./canvasRenderer/canvasRenderer":"canvasRenderer/canvasRenderer.js"}],"../../.nvm/versions/node/v20.7.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../.nvm/versions/node/v20.7.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","code.js"], null)
